...
import {
  ...
  MatPrefix,
  MatSuffix
} from "./chunk-EWGZO5VP.js";
import {
  ErrorStateMatcher,
  _ErrorStateTracker
} from "./chunk-JGVBRJNU.js";
import "./chunk-M5T7YSLV.js";
import "./chunk-TBK7GSUV.js";
import "./chunk-RY37ZQKL.js";
...
} from "./chunk-BA2O6AVN.js";
import "./chunk-HJTKKQ3X.js";
import {
  Directionality
} from "./chunk-XGTUBXNI.js";
import "./chunk-CI6NSQ3K.js";
...
import {
  ...
  NgForm,
  Validators
} from "./chunk-NRX74M2W.js";
import {
  NgClass
} from "./chunk-YD47CCIU.js";
...
// node_modules/@angular/cdk/fesm2022/selection-model-a3c34752.mjs
...
// node_modules/@angular/material/fesm2022/module-d4c8147a.mjs
...
var MatSelect = class _MatSelect {
  ...
  _initialized = new import_rxjs3.Subject();
  _cleanupDetach;
  ...
  _destroy = new import_rxjs3.Subject();
   ...
   * @docs-private
   */
  stateChanges = new import_rxjs3.Subject();
  /**
  ...
  optionSelectionChanges = (0, import_rxjs3.defer)(() => {
    const options = this.options;
    if (options) {
      return options.changes.pipe((0, import_operators.startWith)(options), (0, import_operators.switchMap)(() => (0, import_rxjs3.merge)(...options.map((option) => option.onSelectionChange))));
    }
  ...
  _resetOptions() {
    const changedOrDestroyed = (0, import_rxjs3.merge)(this.options.changes, this._destroy);
    ...
    (0, import_rxjs3.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
