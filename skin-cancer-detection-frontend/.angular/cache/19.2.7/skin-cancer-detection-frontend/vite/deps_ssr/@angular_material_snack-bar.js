...
import {
  ...
  hasModifierKey
} from "./chunk-Q7UHTJO7.js";
import {
  BidiModule,
  Directionality
} from "./chunk-HRCE66UV.js";
import {
  Location
...
// node_modules/@angular/cdk/fesm2022/scrolling-module-7799f57e.mjs
var import_rxjs4 = __toESM(require_cjs(), 1);
var import_operators2 = __toESM(require_operators(), 1);

// node_modules/@angular/cdk/fesm2022/recycle-view-repeater-strategy-7fe34ce5.mjs
...
function isDataSource(value) {
  return value && typeof value.connect === "function" && !(value instanceof import_rxjs2.ConnectableObservable);
}
...
var ArrayDataSource = class extends DataSource {
  ...
  connect() {
    return (0, import_rxjs3.isObservable)(this._data) ? this._data : (0, import_rxjs3.of)(this._data);
  }
  disconnect() {
  }
};
...
var FixedSizeVirtualScrollStrategy = class {
  _scrolledIndexChange = new import_rxjs4.Subject();
  /** @docs-private Implemented as part of VirtualScrollStrategy. */
  scrolledIndexChange = this._scrolledIndexChange.pipe((0, import_operators2.distinctUntilChanged)());
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  _scrolled = new import_rxjs4.Subject();
  ...
  scrolled(auditTimeInMs = DEFAULT_SCROLL_TIME) {
    ...
    return new import_rxjs4.Observable((observer) => {
      ...
      const subscription = auditTimeInMs > 0 ? this._scrolled.pipe((0, import_operators2.auditTime)(auditTimeInMs)).subscribe(observer) : this._scrolled.subscribe(observer);
      this._scrolledCount++;
      return () => {
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe((0, import_operators2.filter)((target) => !target || ancestors.indexOf(target) > -1));
  }
...
var CdkScrollable = class _CdkScrollable {
  ...
  _cleanupScroll;
  _elementScrolled = new import_rxjs4.Subject();
  constructor() {
  }
  ngOnInit() {
...
var ViewportRuler = class _ViewportRuler {
  ...
  _change = new import_rxjs4.Subject();
  ...
  change(throttleTime = DEFAULT_RESIZE_TIME) {
    return throttleTime > 0 ? this._change.pipe((0, import_operators2.auditTime)(throttleTime)) : this._change;
  }
...
var SCROLL_SCHEDULER = typeof requestAnimationFrame !== "undefined" ? import_rxjs4.animationFrameScheduler : import_rxjs4.asapScheduler;
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  _detachedSubject = new import_rxjs4.Subject();
  /** Emits when the rendered range changes. */
  _renderedRangeSubject = new import_rxjs4.Subject();
  ...
  scrolledIndexChange = new import_rxjs4.Observable((observer) => this._scrollStrategy.scrolledIndexChange.subscribe((index) => Promise.resolve().then(() => this.ngZone.run(() => observer.next(index)))));
  ...
  _viewportChanges = import_rxjs4.Subscription.EMPTY;
  ...
  ngOnInit() {
    ...
    this.ngZone.runOutsideAngular(() => Promise.resolve().then(() => {
      ...
      this.scrollable.elementScrolled().pipe(
        ...
        (0, import_operators2.startWith)(null),
        // Collect multiple events into one until the next animation frame. This way if
        // there are multiple scroll events in the same frame we only need to recheck
        // our layout once.
        (0, import_operators2.auditTime)(0, SCROLL_SCHEDULER),
        // Usually `elementScrolled` is completed when the scrollable is destroyed, but
        // that may not be the case if a `CdkVirtualScrollableElement` is used so we have
        // to unsubscribe here just in case.
        (0, import_operators2.takeUntil)(this._destroyed)
  ...
  attach(forOf) {
    ...
    this.ngZone.runOutsideAngular(() => {
      this._forOf = forOf;
      this._forOf.dataStream.pipe((0, import_operators2.takeUntil)(this._detachedSubject)).subscribe((data) => {
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  viewChange = new import_rxjs4.Subject();
  /** Subject that emits when a new DataSource instance is given. */
  _dataSourceChanges = new import_rxjs4.Subject();
  ...
  set cdkVirtualForOf(value) {
    ...
    if (isDataSource(value)) {
      ...
      this._dataSourceChanges.next(new ArrayDataSource((0, import_rxjs4.isObservable)(value) ? value : Array.from(value || [])));
    }
  }
  _cdkVirtualForOf;
  /**
  ...
  dataStream = this._dataSourceChanges.pipe(
    ...
    (0, import_operators2.pairwise)(),
    // Use `_changeDataSource` to disconnect from the previous data source and connect to the
    // new one, passing back a stream of data changes which we run through `switchMap` to give
    // us a data stream that emits the latest data from whatever the current `DataSource` is.
    (0, import_operators2.switchMap)(([prev, cur]) => this._changeDataSource(prev, cur)),
    // Replay the last emitted data when someone subscribes.
    (0, import_operators2.shareReplay)(1)
  );
  ...
  constructor() {
    ...
    this._viewport.renderedRangeStream.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe((range) => {
  ...
  _changeDataSource(oldDs, newDs) {
    ...
    this._needsUpdate = true;
    return newDs ? newDs.connect(this) : (0, import_rxjs4.of)();
  }
...
var CloseScrollStrategy = class {
  ...
  enable() {
    ...
    const stream = this._scrollDispatcher.scrolled(0).pipe((0, import_operators3.filter)((scrollable) => {
...
var OverlayRef = class {
  ...
  _injector;
  _renderer;
  _backdropClick = new import_rxjs5.Subject();
  _attachments = new import_rxjs5.Subject();
  _detachments = new import_rxjs5.Subject();
  _positionStrategy;
  _scrollStrategy;
  _locationChanges = import_rxjs5.Subscription.EMPTY;
  _backdropRef = null;
  /**
  ...
  _keydownEvents = new import_rxjs5.Subject();
  /** Stream of mouse outside events dispatched to this overlay. */
  _outsidePointerEvents = new import_rxjs5.Subject();
  _renders = new import_rxjs5.Subject();
  _afterRenderRef;
  ...
  _detachContentWhenEmpty() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._renders.pipe((0, import_operators3.takeUntil)((0, import_rxjs5.merge)(this._attachments, this._detachments))).subscribe(() => {
...
var FlexibleConnectedPositionStrategy = class {
  ...
  _positionChanges = new import_rxjs5.Subject();
  /** Subscription to viewport size changes. */
  _resizeSubscription = import_rxjs5.Subscription.EMPTY;
...
var CdkConnectedOverlay = class _CdkConnectedOverlay {
  ...
  _overlayRef;
  _templatePortal;
  _backdropSubscription = import_rxjs5.Subscription.EMPTY;
  _attachSubscription = import_rxjs5.Subscription.EMPTY;
  _detachSubscription = import_rxjs5.Subscription.EMPTY;
  _positionSubscription = import_rxjs5.Subscription.EMPTY;
  _offsetX;
  _offsetY;
  _position;
  ...
  attachOverlay() {
    ...
    if (this.positionChange.observers.length > 0) {
      this._positionSubscription = this._position.positionChanges.pipe((0, import_operators3.takeWhile)(() => this.positionChange.observers.length > 0)).subscribe((position) => {
...
var MatSnackBarRef = class {
  ...
  _afterDismissed = new import_rxjs7.Subject();
  /** Subject for notifying the user that the snack bar has opened and appeared. */
  _afterOpened = new import_rxjs7.Subject();
  /** Subject for notifying the user that the snack bar action was called. */
  _onAction = new import_rxjs7.Subject();
  /**
...
var MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  ...
  _onAnnounce = new import_rxjs7.Subject();
  /** Subject for notifying that the snack bar has exited from view. */
  _onExit = new import_rxjs7.Subject();
  /** Subject for notifying that the snack bar has finished entering the view. */
  _onEnter = new import_rxjs7.Subject();
  ...
  enter() {
    if (!this._destroyed) {
      ...
      if (this._animationsDisabled) {
        this._renders.pipe((0, import_operators5.take)(1)).subscribe(() => {
  ...
  exit() {
    if (this._destroyed) {
      return (0, import_rxjs7.of)(void 0);
    }
    this._ngZone.run(() => {
...
var MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    ...
    this._breakpointObserver.observe(Breakpoints.HandsetPortrait).pipe((0, import_operators5.takeUntil)(overlayRef.detachments())).subscribe((state) => {
