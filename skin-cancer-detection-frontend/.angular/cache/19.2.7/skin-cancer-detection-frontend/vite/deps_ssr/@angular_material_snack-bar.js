...
import "./chunk-XGTUBXNI.js";
import "./chunk-CI6NSQ3K.js";
import {
  Platform
} from "./chunk-S2OPAIXG.js";
import "./chunk-YD47CCIU.js";
import {
  DOCUMENT
} from "./chunk-QAQMKGU6.js";
import {
...
var MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  ...
  _enterFallback;
  _exitFallback;
  _renders = new import_rxjs2.Subject();
  ...
  enter() {
    if (!this._destroyed) {
      ...
      if (this._animationsDisabled) {
        this._renders.pipe((0, import_operators2.take)(1)).subscribe(() => {
...
var MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    ...
    this._breakpointObserver.observe(Breakpoints.HandsetPortrait).pipe((0, import_operators2.takeUntil)(overlayRef.detachments())).subscribe((state) => {
